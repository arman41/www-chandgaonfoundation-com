...
/**
 * Premium "Visa / Mastercard"-inspired smart ID card.
  ...
  return (
    <div
      ...
      style={{
        aspectRatio: "1.586 / 1",
        background:
          "radial-gradient(120% 80% at 0% 0%, #1a2f5c 0%, transparent 55%)," +
          "radial-gradient(120% 80% at 100% 100%, #c9a14a 0%, transparent 50%)," +
          "linear-gradient(135deg, #0a1530 0%, #0c2340 40%, #1b3a6b 100%)",
        boxShadow:
    ...
    >
      ...
      <div className="absolute top-[6%] left-[6%] right-[6%] flex items-start justify-between">
        ...
        <div
          className="px-2 py-0.5 rounded-md text-[8px] sm:text-[10px] font-extrabold tracking-widest"
          style={{
      ...
      {/* Chip */}
      <div
        className="absolute top-[34%] left-[6%] w-[14%] aspect-[4/3] rounded-md"
        style={{
          background:
      ...
      {/* Contactless waves */}
      <svg aria-hidden className="absolute top-[36%] left-[22%] w-[8%] opacity-80" viewBox="0 0 24 24" fill="none">
      ...
      {/* Photo */}
      <div
        className="absolute top-[10%] right-[6%] w-[22%] aspect-square rounded-xl overflow-hidden border"
      ...
      <div className="absolute left-[6%] right-[6%] top-[58%]">
        <p
      ...
      {/* tiny QR overlay (verify) */}
      {verifyUrl && (
        <div className="absolute top-[6%] right-[32%] hidden">{/* placeholder, QR shown on back */}
