...
export const Route = createFileRoute("/donations")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "ডোনেশন ট্র্যাক ও রসিদ যাচাই" },
      { name: "twitter:description", content: "TX ID এবং মোবাইল নম্বরের শেষ ৪ ডিজিট দিয়ে আপনার দানের অবস্থা যাচাই করুন।" },
      { property: "og:image", content: "https://www.chandgaonfundition.xyz/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "ডোনেশন ট্র্যাক ও রসিদ যাচাই" },
