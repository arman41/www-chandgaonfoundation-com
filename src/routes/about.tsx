...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://chandgaonfoundation.com/about" },
    ...
    links: [{ rel: "canonical", href: "https://chandgaonfoundation.com/about" }],
  }),
  component: About,
});
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20">
      ...
      <div className="mt-10 prose prose-lg max-w-none text-foreground/85 space-y-6 leading-relaxed">
        <p>
          <strong>{t("চাঁদগাও প্রবাসী ও যুবসমাজ কল্যান ফাউন্ডেশন", "Chandgaon Pravasi & Youth Welfare Foundation")}</strong>{" "}
          {t(
            "কুমিল্লার লাকসাম উপজেলার চাঁদগাও এলাকার প্রবাসী ভাই-বোন ও স্থানীয় যুবসমাজের যৌথ উদ্যোগে প্রতিষ্ঠিত একটি অলাভজনক, দাতব্য প্রতিষ্ঠান। দরিদ্র, অসহায় ও দুঃস্থ মানুষের পাশে দাঁড়ানোই আমাদের মূল লক্ষ্য।",
      ...
      <div className="mt-16 grid md:grid-cols-2 gap-6">
        <div className="p-8 rounded-2xl bg-card border border-border">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            {t(
              "চাঁদগাও, লাকসাম ও বৃহত্তর কুমিল্লার প্রতিটি দরিদ্র পরিবারের কাছে খাদ্য, শিক্ষা, চিকিৎসা ও আশ্রয়ের সুযোগ পৌঁছে দেওয়া।",
