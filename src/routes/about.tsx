...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "আমাদের সম্পর্কে — চাঁদগাঁও ফাউন্ডেশন" },
      { name: "twitter:description", content: "চাঁদগাঁও প্রবাসী ও যুবসমাজের যৌথ উদ্যোগে প্রতিষ্ঠিত একটি অলাভজনক দাতব্য প্রতিষ্ঠান—দরিদ্র, অসহায় ও দুঃস্থ মানুষের পাশে দাঁড়িয়ে খাদ্য, শিক্ষা, চিকিৎসা ও আশ্রয়ের সেবা পৌঁছে দিচ্ছি।" },
      { property: "og:image", content: "https://www.chandgaonfundition.xyz/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "আমাদের সম্পর্কে — চাঁদগাঁও ফাউন্ডেশন" },
