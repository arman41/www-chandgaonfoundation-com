...
const DEFAULT_METHODS: Method[] = [
  ...
  { id: "rocket", labelBn: "রকেট", labelEn: "Rocket", num: "01711479595", typeBn: "পার্সোনাল", typeEn: "Personal", color: "#8E2C8B", fg: "#fff" },
  { id: "bank", labelBn: "ইসলামি ব্যাংক", labelEn: "Islami Bank", num: "02676783", typeBn: "Islami Bank Bangladesh — লাকসাম শাখা", typeEn: "Islami Bank Bangladesh — laksham Branch", color: "#0c2340", fg: "#fff" },
];
